    ...
    <div className="w-screen h-screen flex justify-center items-center">
      <div role="status" className="flex flex-col items-center gap-2 relative">
        ...
        >
          ...
          <path
            strokeLinecap="round"
            strokeDasharray={typeof percent === 'number' ? 60 + (percent * 51) : 60}
            strokeDashoffset="60"
            strokeWidth="0.8"
            stroke="#e5a2ff"
            fill="none"
        ...
        <span className="absolute top-[32%] text-sm">
          {typeof percent === 'number' && Intl.NumberFormat('pt-BR', { minimumFractionDigits: 0, maximumFractionDigits: 0, style: 'percent'}).format(percent)}
        </span>
        <span className={label ? "whitespace-pre text-center" : "sr-only"}>
